...
**Source of truth:** `career-tools/linkedin/candidate-profile.md` (synced from `resume-system/facts/work-experience.md` + `resume-system/facts/projects/*.md`).
...
**Experience:** Digital Aid Seattle Software Engineer (June 2026–Present) · ASU Data Management Intern (Jan–May 2026) · eInfochips Software Engineer Intern (Jan–May 2024) — see `resume-system/facts/work-experience.md` for facts.
...
- **#3 (LinkedIn connection note):** **Deprecated here** — use `career-tools/linkedin/linkedin-connection-note.md` (intents: `network` | `ask` | `referral` with optional JD paste).
