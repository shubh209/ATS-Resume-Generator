...
- Full Stack: Built a cross-platform mobile app with TypeScript, React Native, REST APIs, SQL, and Cloudflare Workers, designed to help people explore historical crypto investment scenarios through city-based purchasing-power comparisons.
- Full Stack: Created a historical-market-data cleanup workflow with Python, Git, CI/CD, and DevOps that filters unreliable records before they reach simulations, designed to make educational results easier to inspect and trust.
- Full Stack: Built event-driven simulation workflows with JavaScript, React Query, market data, and Jest, designed to help beginner investors connect major news with hypothetical crypto decisions.
- Backend: Built crypto valuation services with Python, SQL, Cloudflare D1, and historical analytics, designed to translate an old crypto decision into rent, grocery, and daily-life comparisons.
- Backend: Built event-scenario workflows with TypeScript, Hono, REST APIs, Cloudflare Workers, Cloudflare KV, and Jest, designed to explain how delayed buying after major headlines changes a hypothetical result.
