...
## Recommended Resume Projects (4 per role)

Bullet counts: positions **1–2 = 3 bullets each** · positions **3–4 = 2 bullets each**
...
**Status caveat:** Local prototype with simulated GPU telemetry. No real GPUs, Kubernetes, LLM, or cloud deployment. All metrics are ESTIMATE/UNKNOWN — see `gpt/projects/ClusterOps.md` Never Claim section.
...
| AI Engineer | Video Compliance → Fake Review → Distributed Caching → Hearloop | Video Compliance (11/13) | SEO Audit (1/13) |
