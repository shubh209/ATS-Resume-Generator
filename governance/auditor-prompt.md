...
3. Fact Check table
4. Changed LaTeX sections
5. Master context (`gpt/work-experience.md`, relevant `gpt/projects/*.md`)
6. `governance/OUTPUT_CONTRACT.md`, `governance/FACT_RULES.md`, `governance/DEFINITION_OF_DONE.md`
